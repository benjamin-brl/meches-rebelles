...
<head>
    ...
    <?= $page == 'Accueil' ? "<style type='text/css'>:root { --nombre-onglets: $nombreOnglet }</style>" : '' ?>
    <link rel="stylesheet" type="text/css" href="css/styles.css" />
    <link rel="icon" href="assets/favicon.svg" type="image/svg+xml" />
    <title><?=$firm_info["nom"].' | '.$page?></title>
</head>

<?php if ($page == 'Admin' && isset($critere)) { ?>
<body id="<?=$critere?>">
<?php } else { ?>
<body>
<?php } ?>
    <header>
        <nav class="navbar">
            <ul class="nav-menu">
                <li class="nav-item">
                    <a href="?a=evenement" class="nav-link">Évènementielle</a>
                </li>

                <li class="nav-item">
                    <a href="?a=horaires" class="nav-link">Horaires</a>
                </li>

                <li class="nav-item">
                    <a href="?a=secteur" class="nav-link">Secteur d'Activité</a>
                </li>

                <li class="nav-item">
                    <a href="?a=galerie" class="nav-link">Galerie Photos</a>
                </li>

                <li class="nav-item">
                    <a href="?a=contact" class="nav-link">Contact</a>
                </li>
                <?php if ($page == 'Admin' && isset($critere)) { ?>
                <li class="nav-item">
                    <a id="disconnect" class="nav-link">Déconnection</a>
                </li>
                <?php } ?>
            </ul>
